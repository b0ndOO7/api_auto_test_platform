...
//        try {
            ...
            HashMap<String, Object> returnMap = testCaseService.getApiList(uid, keyWord, curPage, pageSize, searchScope);
...
//        }
     ...
     * @return
     */
    @RequestMapping("getapibypid")
    public Result getApiByProjectId(@RequestHeader String uid, @RequestBody ProjectEntity projectEntity) {
        log.info("getApiByProjectId: {}", FastJsonUtil.parseToJSON(projectEntity));
//        testCaseService.getApiListByPid(uid, projectEntity.getId());
        return ResultUtils.success(testCaseService.getApiListByPid(uid, projectEntity.getId()));
    }
